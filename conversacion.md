...
**Agente:** README ampliado: modelo de ramas, flujo proyecto/feature, reglas para IA/Codex, despliegues y protección GitHub — fuente de verdad para cómo se trabaja en este sandbox.
